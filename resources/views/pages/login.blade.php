    ...
    <div class="w-full max-w-[460px] px-6 relative z-10">
        ...
        <div class="bg-[#1A1512] border border-[#2A231F] rounded-3xl p-8 md:p-10 shadow-2xl animate-fade-in-smooth delay-1">
            ...
            <div class="text-center mb-8">
                <h1 class="text-[28px] font-medium tracking-wide mb-1 text-[#F3EFEA]">Welcome Back to <span class="font-semibold">LUNƐ</span></h1>
            ...
            <div class="my-7 relative flex items-center justify-center animate-fade-in-smooth delay-3">
                ...
                <span class="bg-[#1A1512] px-4 text-[13px] text-[#A89F95] relative z-10 font-light tracking-wide">Log-in with another way</span>
            </div>
            ...
            <div class="space-y-3 animate-fade-in-smooth delay-3">
                ...
                <button type="button" class="w-full bg-[#120F0D] border border-[#2A231F] hover:bg-[#1C1714] hover:border-[#4E413B] transition-all duration-300 py-3 rounded-xl flex items-center justify-center space-x-3 group">
                    ...
                    <span class="text-[13px] text-[#A89F95] font-light group-hover:text-[#F3EFEA] transition-colors">Log-in with Google</span>
                </button>
                ...
                <button type="button" class="w-full bg-[#120F0D] border border-[#2A231F] hover:bg-[#1C1714] hover:border-[#4E413B] transition-all duration-300 py-3 rounded-xl flex items-center justify-center space-x-3 group">
                    ...
                    <span class="text-[13px] text-[#A89F95] font-light group-hover:text-[#F3EFEA] transition-colors">Log-in with Apple</span>
                </button>
            </div>
            ...
            <p class="text-center mt-8 text-[13px] text-[#A89F95] font-light animate-fade-in-smooth delay-3">
                Belum Punya Akun? 
                <a href="#" class="text-[#F3EFEA] font-medium hover:underline hover:text-white transition-colors ml-1">Sign-up Sekarang</a>
            </p>
